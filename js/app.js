...
const gallery = document.querySelectorAll('.thumbs');
...
const productsInShoppingCart = document.querySelector('.product-in-cart');
...
function addToCart () {
    ...
    const productHTMLElement = `
        <div class="item">
            <img class="item-thumb" src="./images/image-product-1-thumbnail.jpg" alt="product 1 thumb">
            <div class="details">
